...
for task in $ntasks;do
   ...
   trajectory_file=$scriptdir/../simulation_setup/${simulationtype}/gammaA${gammaA}_gammapatch${gammapatch}/Nclusters${Nclusters}/Np${Np}/R${R}/radiusB${radiusB}/areafraction${areafraction}/epsilon${epsilon}/kspring${kspring}/seed${seed}/restlength${restlength}/${simulationtype}_restl${restlength}_Nc${Nclusters}_Np${Np}_R${R}_rB${radiusB}_areafrac${areafraction}_eps${epsilon}_kspring${kspring}_gammaA${gammaA}_gammapatch${gammapatch}_seed${seed}.allruns.gsd

   echo "trajectory_file=$trajectory_file"

   $wrapper python -u cluster_analysis_bondvalence.py --trajectory_file $trajectory_file --dt $dt
   $wrapper python -u clustersizes_analysis.py --trajectory_file $trajectory_file --dt $dt 
