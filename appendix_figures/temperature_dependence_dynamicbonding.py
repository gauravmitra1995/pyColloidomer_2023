...
ax[0].text(1.2,0.1,r"$\rightarrow T_{melt}$",fontsize=20)
...
ax[1].text(1.2,0.9,r"$\rightarrow T_{melt}$",fontsize=20)
ax[1].set_xlabel(r'$T/T^{*}$',fontsize=20,fontweight='bold')
ax[1].set_ylabel(r'$f_{bound}(T)$',fontsize=20,fontweight='bold')
ax[1].axvline(x=Tm,linestyle='--',color='black')
